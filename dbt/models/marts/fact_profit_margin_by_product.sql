...
with 
    sales_salesorderdetail as (
        ...
        group by sales_salesorderdetail.productid_id
    ),
    ...
    production_productcosthistory as (
        ...
        group by production_productcosthistory.productid_id
    ),
    ...
    profit_calculation as (
        select
            ...
            ,round(sales_salesorderdetail.total_revenue - (sales_salesorderdetail.total_revenue / production_product.listprice_vr) * production_productcosthistory.avg_cost, 2) as total_profit
            ,round((sales_salesorderdetail.total_revenue - (sales_salesorderdetail.total_revenue / production_product.listprice_vr) * production_productcosthistory.avg_cost) / sales_salesorderdetail.total_revenue * 100, 2) as profit_margin_percentage
